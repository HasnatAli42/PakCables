...
@Composable
fun InputView (input : InputRequestModel){
    val bgColor = buttonColor
    ...
    val core6InputUnit = remember { mutableStateOf(Conversion.METERS) }
        ...
        input.red = when (redInput.value.toIntOrNull()){
         ...
         totalInput.value = (input.red + input.black +input.blue +input.green +input.yellow +input.white +input.other).toString()
          }
    ...
    Column(
        ...
        Row (
            ...
            Card(
                ...
                Text(text = input.itemName, color = Color.White ,modifier = Modifier
                    .background(Color.Black)
                    .align(alignment = CenterVertically))
            }
            Row(modifier = Modifier.fillMaxWidth(0.35f)){
                OutLineTextFieldWithIntegerTotalInput(labelText = totalText, integerInputState = totalInput)
            }
            Row(modifier = Modifier.fillMaxWidth(0.6f)){
                OutLineTextFieldWithIntegerInput(labelText = otherText, integerInputState = otherInput)
            }
        }
        Row(horizontalArrangement = Arrangement.SpaceAround,
            ...
            Row(modifier = Modifier.fillMaxWidth(0.27f)){
                OutLineTextFieldWithIntegerInput(labelText = redText, integerInputState = redInput)
            }
            Row(modifier = Modifier.fillMaxWidth(0.35f)){
                OutLineTextFieldWithIntegerInput(labelText = blackText, integerInputState = blackInput)
            }
            Row(modifier = Modifier.fillMaxWidth(0.6f)){
                OutLineTextFieldWithIntegerInput(labelText = blueText, integerInputState = blueInput)
            }
        }
        ...
        Row(horizontalArrangement = Arrangement.SpaceAround,
            ...
            modifier = Modifier.fillMaxWidth()) {
            Row(modifier = Modifier.fillMaxWidth(0.27f)){
                OutLineTextFieldWithIntegerInput(labelText = greenText, integerInputState = greenInput)
            }
            Row(modifier = Modifier.fillMaxWidth(0.35f)){
                OutLineTextFieldWithIntegerInput(labelText = yellowText, integerInputState = yellowInput)
            }
            Row(modifier = Modifier.fillMaxWidth(0.6f)){
                OutLineTextFieldWithIntegerInput(labelText = whiteText, integerInputState = whiteInput)
            }
        }
        ...
        Row(horizontalArrangement = Arrangement.SpaceAround,
            ...
            Row(modifier = Modifier.fillMaxWidth(0.4f)){
                MeasurementConverterOutLineTextField(labelText = core2Text, inputValue = core2Input, selectedConversion = core2InputUnit)
            }
            Row(modifier = Modifier.fillMaxWidth(0.8f)){
                MeasurementConverterOutLineTextField(labelText = core3Text, inputValue = core3Input, selectedConversion = core3InputUnit)
            }
        }
        Row(horizontalArrangement = Arrangement.SpaceAround,
            verticalAlignment = Alignment.CenterVertically,
            modifier = Modifier.fillMaxWidth()) {
            Row(modifier = Modifier.fillMaxWidth(0.4f)){
                MeasurementConverterOutLineTextField(labelText = core4Text, inputValue = core4Input, selectedConversion = core4InputUnit)
            }
            Row(modifier = Modifier.fillMaxWidth(0.8f)){
                MeasurementConverterOutLineTextField(labelText = core5Text, inputValue = core5Input, selectedConversion = core5InputUnit)
            }
        }
        Row(horizontalArrangement = Arrangement.SpaceAround,
            verticalAlignment = Alignment.CenterVertically,
            ...
            Row(modifier = Modifier.fillMaxWidth(0.95f)){
                MeasurementConverterOutLineTextField(labelText = core6Text, inputValue = core6Input, selectedConversion = core6InputUnit)
            }
        }
    }
    }
